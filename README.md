...
Continuação do desenvolvenvimento da aplicação de gestão de transações, treinando o que você aprendi até agora no Node.js junto ao TypeScript, mas dessa vez incluindo o uso de banco de dados com o TypeORM e envio de arquivos com o Multer!
...
Esse projeto está sob a licença MIT. Veja o arquivo [LICENSE](https://github.com/Rocketseat/bootcamp-gostack-desafios/blob/master/desafio-database-upload/LICENSE) para mais detalhes.
